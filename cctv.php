  ...
  <div class="row g-0">
    ...
    <div class="col-md-6">
      <div class="card-body">
        ...
        <p class="card-text"><strong style="color:#02245b;font-size:17px;">1-Vigilancia y monitorización:</strong> Los sistemas de CCTV permiten la vigilancia y la monitorización en tiempo real de áreas críticas, lo que puede ser vital para la seguridad en entornos como aeropuertos, estaciones de tren, hospitales, y áreas industriales. <br><br>
        <strong style="color:#02245b;font-size:17px;">2-Seguridad y prevención de delitos:</strong> La razón más común para implementar un sistema de CCTV es aumentar la seguridad. La presencia de cámaras de seguridad puede disuadir a posibles delincuentes y actuar como una medida preventiva contra el robo, el vandalismo y otros delitos.</p>
